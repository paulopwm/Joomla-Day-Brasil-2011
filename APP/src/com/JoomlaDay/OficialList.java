...
public class OficialList extends GDListActivity {
    ...
    private void getTweets(){
    	try {
			progressDialog = ProgressDialog.show(OficialList.this, null, this.getString(R.string.loading), false, true);
	    } catch (Exception e) {
	    	Log.e("Dialog", e.toString());
	    }
	    Thread t = new Thread() {
            public void run() {
            	String url = getString(R.string.url_twitteroficial);
            	newTweets = internet.getTwitter(url, OficialList.this);
    ...
    public boolean onHandleActionBarItemClick(ActionBarItem item, int position) {
        ...
        switch (item.getItemId()) {
            case R.id.action_bar_refresh:
            	...
            	if (internet.checkInternetConnection(OficialList.this)){
    	    		FileCache.clear();
    	    	}
            	getTweets();
                break;
	...
	public void showAlert(){
		AlertDialog.Builder adb = new AlertDialog.Builder(OficialList.this);
